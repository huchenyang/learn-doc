...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="https://git.thpyun.com/thpower-bladex/thpower-platform-examples" target="_blank" rel="noopener noreferrer">参考示例代码：下载地址<ExternalLinkIcon/></a></p>
<p>消息中心模块名：thpower-notice-demo</p>
...
<td>List <String></td>
<td>否</td>
<td>用户id集合，<br />即公共平台的账户id</td>
</tr>
<tr>
<td>noticeModes</td>
<td>String</td>
<td>否</td>
<td>推送方式,<br />多个逗号间隔（见定义参数）</td>
</tr>
<tr>
<td>sendMessage</td>
...
<td>String</td>
<td>是</td>
<td>用户自定义数据，<br />业务功能自由扩展使用</td>
</tr>
<tr>
<td>└── msgType</td>
<td>Integer</td>
<td>是</td>
<td>消息类型：<br />1消息通知，2系统通知（见说明）</td>
</tr>
<tr>
<td>└── appSource</td>
<td>String</td>
<td>是</td>
<td>app数据来源<br /> （见定义参数）</td>
</tr>
<tr>
<td>└── actionType</td>
<td>String</td>
<td>是</td>
<td>动作类型 ,定义<br />（见定义参数值）</td>
</tr>
<tr>
<td>└── msgBizTypeItem</td>
<td>String</td>
<td>是</td>
<td>自定义业务类型项 ，<br />建议传递code值</td>
</tr>
</tbody>
</table>
<ul>
...
<td>Integer</td>
<td>是</td>
<td>消息类型：<br />1消息通知，2系统通知（见说明）同上</td>
</tr>
<tr>
<td>└── appSource</td>
<td>String</td>
<td>是</td>
<td>app数据来源 <br />（见定义参数）同上</td>
</tr>
<tr>
<td>└── actionType</td>
<td>String</td>
<td>是</td>
<td>动作类型 ,<br />定义（见定义参数）同上</td>
</tr>
<tr>
<td>└── msgBizTypeItem</td>
<td>String</td>
...
<td>String</td>
<td></td>
<td>推送目的地址：<br />如“xxxqq@.com” 、username等</td>
</tr>
<tr>
<td>#        ├──  userId</td>
<td>String</td>
...
<td>String</td>
<td></td>
<td>自定义业务类型项 ，<br />业务系统按自有业务类型，建议传递code值</td>
</tr>
</tbody>
</table>
<ul>
