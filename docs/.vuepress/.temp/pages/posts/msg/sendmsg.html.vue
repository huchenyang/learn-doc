<template><div><h3 id="客户端sdk" tabindex="-1"><a class="header-anchor" href="#客户端sdk" aria-hidden="true">#</a> 客户端sdk</h3>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token entity named-entity" title="&lt;">&amp;lt;</span>dependency<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>groupId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>org.springblade<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/groupId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>artifactId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>thpower-core-boot<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/artifactId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>version<span class="token entity named-entity" title="&gt;">&amp;gt;</span>3.0.12-SNAPSHOT<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/version<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>exclusions<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
       <span class="token entity named-entity" title="&lt;">&amp;lt;</span>exclusion<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
           <span class="token entity named-entity" title="&lt;">&amp;lt;</span>groupId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>org.springframework.cloud<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/groupId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
           <span class="token entity named-entity" title="&lt;">&amp;lt;</span>artifactId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>spring-cloud-stream<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/artifactId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
        <span class="token entity named-entity" title="&lt;">&amp;lt;</span>/exclusion<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
     <span class="token entity named-entity" title="&lt;">&amp;lt;</span>/exclusions<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/dependency<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
<span class="token entity named-entity" title="&lt;">&amp;lt;</span>dependency<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>groupId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>org.springblade<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/groupId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>artifactId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>thpower-notice-api<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/artifactId<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
    <span class="token entity named-entity" title="&lt;">&amp;lt;</span>version<span class="token entity named-entity" title="&gt;">&amp;gt;</span>4.0.7-SNAPSHOT<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/version<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
<span class="token entity named-entity" title="&lt;">&amp;lt;</span>/dependency<span class="token entity named-entity" title="&gt;">&amp;gt;</span>
...
<h3 id="发送消息通知" tabindex="-1"><a class="header-anchor" href="#发送消息通知" aria-hidden="true">#</a> 发送消息通知</h3>
<h4 id="平台推送-浏览器、邮箱、钉钉、短信等" tabindex="-1"><a class="header-anchor" href="#平台推送-浏览器、邮箱、钉钉、短信等" aria-hidden="true">#</a> 平台推送（浏览器、邮箱、钉钉、短信等）</h4>
...
<span class="token class-name">Map</span><span class="token operator">&amp;</span>lt<span class="token punctuation">;</span><span class="token class-name">String</span><span class="token punctuation">,</span> <span class="token class-name">String</span><span class="token operator">&amp;</span>gt<span class="token punctuation">;</span> map <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">HashMap</span><span class="token operator">&amp;</span>lt<span class="token punctuation">;</span><span class="token class-name">String</span><span class="token punctuation">,</span> <span class="token class-name">String</span><span class="token operator">&amp;</span>gt<span class="token punctuation">;</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token class-name">List</span><span class="token operator">&amp;</span>lt<span class="token punctuation">;</span><span class="token class-name">String</span><span class="token operator">&amp;</span>gt<span class="token punctuation">;</span> targetIds <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ArrayList</span><span class="token operator">&amp;</span>lt<span class="token punctuation">;</span><span class="token class-name">String</span><span class="token operator">&amp;</span>gt<span class="token punctuation">;</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token class-name">R</span><span class="token operator">&amp;</span>lt<span class="token punctuation">;</span><span class="token class-name">PageVo</span><span class="token operator">&amp;</span>lt<span class="token punctuation">;</span><span class="token class-name">ThpNoticeVO</span><span class="token operator">&amp;</span>gt<span class="token punctuation">;</span><span class="token operator">&amp;</span>gt<span class="token punctuation">;</span> result <span class="token operator">=</span> noticeClient<span class="token punctuation">.</span><span class="token function">searchNoticePage</span><span class="token punctuation">(</span>request<span class="token punctuation">)</span><span class="token punctuation">;</span>
